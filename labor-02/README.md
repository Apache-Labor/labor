...
In Lektion 1 wurde ein Apache Webserver selbst kompiliert. Aber obschon dort die
...
Übrigens: Wenn man bei der obenstehenden Konfiguration einen Fehler macht und
_Suexec_ andere Compilerkonstanten mitgeben möchte, dann muss man vor dem erneuten Compilieren zuerst die
Compiler-Umgebung reinigen. Ansonsten werden die neuen Optionen ignoriert. Dies
...
um alles weitere kümmert. Wir legen das Skript wie vorgesehen in _/apache/bin/php-fcgi-starter/php-fcgi-starter_ ab. 
Das Unterverzeichnis ist nötig, denn _suexec_ setzt voraus, dass das Verzeichnis dem vorkonfigurierten 
Benutzer gehört und wir möchten _./bin_ nicht komplett dem neuen Benutzer übergeben. Legen wir das Unterverzeichnis also an:
